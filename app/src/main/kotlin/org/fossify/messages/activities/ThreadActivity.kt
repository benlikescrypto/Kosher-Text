...
import com.kosherlabs.koshertext.BuildConfig
import com.kosherlabs.koshertext.R
import com.kosherlabs.koshertext.adapters.AttachmentsAdapter
import com.kosherlabs.koshertext.adapters.AutoCompleteTextViewAdapter
import com.kosherlabs.koshertext.adapters.ThreadAdapter
import com.kosherlabs.koshertext.databinding.ActivityThreadBinding
import com.kosherlabs.koshertext.databinding.ItemSelectedContactBinding
import com.kosherlabs.koshertext.dialogs.InvalidNumberDialog
import com.kosherlabs.koshertext.dialogs.RenameConversationDialog
import com.kosherlabs.koshertext.dialogs.ScheduleMessageDialog
import com.kosherlabs.koshertext.extensions.clearExpiredScheduledMessages
import com.kosherlabs.koshertext.extensions.config
import com.kosherlabs.koshertext.extensions.conversationsDB
import com.kosherlabs.koshertext.extensions.copyToUri
import com.kosherlabs.koshertext.extensions.createTemporaryThread
...
import com.kosherlabs.koshertext.extensions.deleteSmsDraft
import com.kosherlabs.koshertext.extensions.dialNumber
import com.kosherlabs.koshertext.extensions.emptyMessagesRecycleBinForConversation
import com.kosherlabs.koshertext.extensions.filterNotInByKey
...
import com.kosherlabs.koshertext.extensions.getMessages
import com.kosherlabs.koshertext.extensions.getSmsDraft
import com.kosherlabs.koshertext.extensions.getThreadId
import com.kosherlabs.koshertext.extensions.getThreadParticipants
import com.kosherlabs.koshertext.extensions.getThreadTitle
import com.kosherlabs.koshertext.extensions.indexOfFirstOrNull
import com.kosherlabs.koshertext.extensions.isGifMimeType
...
import com.kosherlabs.koshertext.extensions.markMessageRead
...
import com.kosherlabs.koshertext.extensions.moveMessageToRecycleBin
import com.kosherlabs.koshertext.extensions.onScroll
import com.kosherlabs.koshertext.extensions.removeDiacriticsIfNeeded
import com.kosherlabs.koshertext.extensions.renameConversation
import com.kosherlabs.koshertext.extensions.restoreAllMessagesFromRecycleBinForConversation
import com.kosherlabs.koshertext.extensions.restoreMessageFromRecycleBin
import com.kosherlabs.koshertext.extensions.saveSmsDraft
import com.kosherlabs.koshertext.extensions.shouldUnarchive
import com.kosherlabs.koshertext.extensions.showWithAnimation
...
import com.kosherlabs.koshertext.extensions.updateScheduledMessagesThreadId
import com.kosherlabs.koshertext.helpers.CAPTURE_AUDIO_INTENT
import com.kosherlabs.koshertext.helpers.CAPTURE_PHOTO_INTENT
import com.kosherlabs.koshertext.helpers.CAPTURE_VIDEO_INTENT
import com.kosherlabs.koshertext.helpers.FILE_SIZE_NONE
import com.kosherlabs.koshertext.helpers.IS_LAUNCHED_FROM_SHORTCUT
import com.kosherlabs.koshertext.helpers.IS_RECYCLE_BIN
import com.kosherlabs.koshertext.helpers.MESSAGES_LIMIT
import com.kosherlabs.koshertext.helpers.PICK_CONTACT_INTENT
import com.kosherlabs.koshertext.helpers.PICK_DOCUMENT_INTENT
import com.kosherlabs.koshertext.helpers.PICK_PHOTO_INTENT
import com.kosherlabs.koshertext.helpers.PICK_SAVE_DIR_INTENT
import com.kosherlabs.koshertext.helpers.PICK_SAVE_FILE_INTENT
import com.kosherlabs.koshertext.helpers.PICK_VIDEO_INTENT
import com.kosherlabs.koshertext.helpers.SEARCHED_MESSAGE_ID
...
import com.kosherlabs.koshertext.helpers.generateRandomId
import com.kosherlabs.koshertext.helpers.refreshConversations
import com.kosherlabs.koshertext.helpers.refreshMessages
import com.kosherlabs.koshertext.messaging.cancelScheduleSendPendingIntent
import com.kosherlabs.koshertext.messaging.isLongMmsMessage
import com.kosherlabs.koshertext.messaging.isShortCodeWithLetters
import com.kosherlabs.koshertext.messaging.scheduleMessage
...
import com.kosherlabs.koshertext.models.SIMCard
import com.kosherlabs.koshertext.models.ThreadItem
import com.kosherlabs.koshertext.models.ThreadItem.ThreadDateTime
import com.kosherlabs.koshertext.models.ThreadItem.ThreadError
import com.kosherlabs.koshertext.models.ThreadItem.ThreadSending
import com.kosherlabs.koshertext.models.ThreadItem.ThreadSent
